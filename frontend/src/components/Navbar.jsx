...
//         <div className='absolute hidden group-hover:block top-0 tight-0 z-10 text-black rounded pt-10'>
...
const Navbar = () => {
  ...
  return (
    <div className='w-full shadow-md flex justify-between items-center p-4 sm:p-6 sm:px-24 absolute top-0'>
      ...
      {userData ? (
        <div className="flex items-center gap-6">
          ...
          <button
            ...
            className="px-4 py-2 rounded-full bg-orange-800  text-white hover:bg-orange-700"
          >
            Write
          </button>
          <button
            onClick={() => navigate('/journals')}
            className="px-4 py-2 rounded-full bg-gray-600 text-white hover:bg-gray-800"
          >
            My Journals
          </button>
